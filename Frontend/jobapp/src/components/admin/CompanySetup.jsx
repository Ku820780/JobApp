...
import useGetCompanyId from '../hook/useGetCompanyId'

function CompanySetup() {
  const params = useParams()
  useGetCompanyId(params.id)
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      setLoading(true)
      const res = await axios.put(`${COMPANY_API_END_POINT}/updatecompanydata/${params.id}`,formdata, {
        headers:{
